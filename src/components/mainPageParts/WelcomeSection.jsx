...
import '../mainPageParts/WelcomeSection.css'
...
function WelcomeSection() {
  return (
    ...
    <div className="welcome-page">
      ...
      <p>Discover the enchanting tales of gods, heroes, and monsters that have captivated humanity for centuries.</p>
      <p>From the majestic halls of Olympus to the mysterious depths of the Norse cosmos, our website is your gateway to a world of wonder and adventure.</p>
