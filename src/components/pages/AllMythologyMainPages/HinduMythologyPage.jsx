...
function HinduMythologyPage() {
  return (
    ...
    <MythologyTemplate 
      ...
      godLiElements={<ul className="godsUl"><li><Link className="GodLink" to='/shiva'>Shiva</Link></li><li><Link className="GodLink" to='/ganesha'>Ganesha</Link></li><li><Link className="GodLink" to='/brahma'>Brahma</Link></li><li><Link className="GodLink" to='/vishnu'>Vishnu</Link></li><li><Link className="GodLink" to='/parvati'>Parvati</Link></li><li><Link className="GodLink" to='/krishna'>Krishna</Link></li></ul>} />
    </>
  )
}
