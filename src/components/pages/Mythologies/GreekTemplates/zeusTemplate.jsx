...
function ZeusTemplate() {
  return (
    <div className='wrapper'>
      ...
      { title: 'Who were Zeus’ parents?' }, 
      { title: 'Who were Zeus’ children?' }, 
      { title: 'What were Zeus’ attributes?' }, 
      { title: 'Zeus defeats Cronus' }, 
