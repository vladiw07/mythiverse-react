  ...
  return (
    <div className='wrapper'>
      ...
      <div className='godTemplate'>
        ...
        <TextSectionTemplate header={<h3 id='content_0'>Overview</h3>} text={<><p>One of the most famous figures of the Ancient Egyptian pantheon, Anubis was a powerful deity whose role shifted over time. Before Osiris and Isis rose to prominence, Anubis was worshipped as the god of the dead. When Osiris took on this role, however, Anubis became the god of mummification (as well as Osiris’s bastard son).</p></>} />
        ...
        <TextSectionTemplate header={<h3 id='content_1'>Etymology</h3>} text={<><p>Like much of the Egyptian pantheon, Anubis’s name came to us as a Greek translation of his Egyptian name. This was partly because the Greeks continued to worship or at least admire the Egyptian gods, but also due to the ambiguity of the vowelless writing system employed in Ancient Egyptians. An accurate, albeit unhelpful, rendering of his name in Ancient Egyptian is jnpw.[1] Some translations of jnpw have rendered Anubis’s Egyptian name as “Anpu” or “Inpu.”</p></>} />
