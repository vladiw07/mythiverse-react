  ...
  return (
    <div className='wrapper'>
      ...
      <div className='godTemplate'>
        ...
        <TextSectionTemplate header={<h3 id='content_1'>Etymology</h3>} text={<><p>In ancient Egyptian, Ra’s name simply meant “sun.” As with many mythologies, Egyptian gods had a multiplicity of names. Ra had many other names, and was sometimes called Re, Amun-Re, Khepri, Ra-Horakhty, and Atum.</p> <p>Each of these names was typically associated with a different aspect of Ra’s being. Such names often emerged as the Egyptians assimilated new deities and religions into their own.</p> <p>His worship likely originated in a town the Egyptians called Iunu. The Greeks referred to this place as Heliopolis, or “city of the sun god.” This ancient city was located in what is now a northern suburb of Cairo.</p></>} />

        <TextSectionTemplate header={<h3 id='content_2'>Attributes</h3>} text={<><p>While Ra was most famous as the Egyptian creator deity, he fulfilled other roles as well. His other titles included god of the sun, god of kings, and god of order.</p> <p>Ra could be depicted in a variety of ways. He most commonly appeared as a solar disk—a circle drawn over the head of various sun deities. Ra was also frequently represented as a man with the head of a falcon.</p> <p>Imagery of Ra often depicted him wielding both a scepter and an ankh.</p></>} />
