  ...
  return (
    <div className='wrapper'>
      <div className='godTemplate'>
        ...
        <TextSectionTemplate header={<h3>Etymology</h3>} text={<><p>Nephthys’s name meant “Lady of the Mansion,” or “Lady of the House.” [1] In this context, the word “house” meant the portion of the sky in which the sun god Horus resided; as such, the name likely referred to priesthood rather than homemaking.</p></>} />

        <TextSectionTemplate header={<h3>Attributes</h3>} text={<><p>In art, Nephthys was usually depicted as a woman bearing the sign of her name atop her head. Like her sister Isis, she was sometimes shown as a kite (a small bird of prey).</p> <p>Nephthys and her sister Isis were commonly sights in tombs, as both goddesses attended the mummification of Osiris and served as protectors of the dead. The two goddesses were often depicted as identical, save for the symbols atop their heads. This detail proved to be significant during Nephthys’s seduction of Osiris, in which she deceived him into believing that she was, in fact, Isis.</p></>} />
