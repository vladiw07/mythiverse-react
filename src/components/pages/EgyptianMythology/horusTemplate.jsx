...
function HorusTemplate() {
  return (
    <div className='wrapper'>
      ...
      { title: 'Horus the Falcon' }, 
      { title: 'Horus the Elder' }, 
      { title: 'Horus the Younger' }, 
      { title: 'Etymology' },
      { title: 'Horus the Younger' },
      { title: 'Attributes' }, 
      ]} />
      <div className='godTemplate'>
        ...
        <TextSectionTemplate header={<h3 id='content_1'>Horus the Falcon</h3>} text={<><p>The deity’s oldest manifestation, Horus the Falcon was also known as Horus the Sky God, Horus the Lord of the Sky, Horus of Two Horizons, Horakhty, Ra-Horakhty, and Hor-em-akhet (Horus in the Horizon, or Harmachis to the Greeks).</p> <p></p> <p></p> <p></p> </>} />

        <TextSectionTemplate header={<h3 id='content_2'>Horus the Elder</h3>} text={<><p>Found only in Greek sources, Horus the Elder was the son of Nut and Geb. He was also known as Horus the Great, Harwer, and Haroeris.</p> <p></p> <p></p> <p></p> </>} />

        <TextSectionTemplate header={<h3 id='content_3'>Horus the Younger</h3>} text={<><p>Horus the Younger is Likely the most recognizable iteration of the deity, Horus the Younger, was the son of Isis and Osiris, and figured prominently in some of the best-known Egyptian myths.</p> <p></p> <p></p> <p></p> </>} />

        <TextSectionTemplate header={<h3 id='content_4'>Etymology</h3>} text={<><p>Horus’s name was derived from the Egyptian word her, meaning “the one on high” or “the distant one,” a reference to a soaring falcon or the sun itself.</p> <p></p> <p></p> <p></p> </>} />

        <TextSectionTemplate header={<h3 id='content_5'>Horus the Younger</h3>} text={<><p>The ancient Egyptians called this iteration Horus the Younger, Harsiese (Horus, son of Isis), and Har-Hery-Wadj (Horus Upon His Papyrus Plants, referencing his birth in the papyrus swamps of Chemmis).</p> <p>He was also referred to as Hor Pa-Khered (literally: Horus the Child) which the Greeks transliterated as Harpokrates.</p> <p></p> <p></p> </>} />

        <TextSectionTemplate header={<h3 id='content_6'>Attributes</h3>} text={<><p>Despite having many different manifestations, the aspects of Horus share many features with one another.</p> <p></p> <p></p> <p></p> </>} /> 
