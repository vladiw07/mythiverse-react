...
function Dionysus() {
  return (
    <div className='wrapper'>
      ...
      { title: 'What were Dionysus’ attributes?' }, 
      { title: 'How was Dionysus worshipped?' }, 
      { title: 'Dionysus and Ariadne' }, 
      { title: 'Attributes' },
