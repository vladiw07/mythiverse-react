...
function Demeter() {
  return (
    <div className='wrapper'>
      ...
      { title: 'What were Demeter’s attributes?' }, 
      { title: 'Who were Demeter’s children?' }, 
      { title: 'Demeter’s Search for Persephone' }, 
      { title: 'Attributes' },
